...
<html>
    <head>
        ...
        <link rel="stylesheet" href="offline/jplayer.blue.monday.min.css" />
        <link rel="stylesheet" href="offline/tui-image-editor.css">
        ...
        <script src="offline/jquery-1.12.4.min.js" integrity="sha256-ZosEbRLbNQzLpnKIkEdrPv7lOy9C27hHQ+Xp8a4MxAQ=" crossorigin="anonymous"></script>
        <script src="offline/jquery-ui.min.js" integrity="sha256-VazP97ZCwtekAsvgPBSUwPFKdrwD3unUfSGVYrahUqU=" crossorigin="anonymous"></script>
        <script src="js/plugins.js?v=<?php echo $version; ?>"></script>
        <script src="offline/jquery.jplayer.min.js"></script>
        <link type="text/css" href="offline/tui-color-picker.css" rel="stylesheet">
        <script type="text/javascript" src="offline/fabric.js"></script>
        <script type="text/javascript" src="offline/tui-code-snippet.min.js"></script>
        <script type="text/javascript" src="offline/FileSaver.min.js"></script>
        <script type="text/javascript" src="offline/tui-color-picker.js"></script>
        <script src="offline/tui-image-editor.js"></script>
...
<body>
    ...
    <script src="offline/tmpl.min.js"></script>
    <!-- The Load Image plugin is included for the preview images and image resizing functionality -->
    <script src="offline/load-image.all.min.js"></script>
    <!-- The Canvas to Blob plugin is included for image resizing functionality -->
    <script src="offline/canvas-to-blob.min.js"></script>

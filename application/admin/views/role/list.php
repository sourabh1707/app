        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <?php $permissions = $this->permissions; if(empty($permissions) || isset($permissions['role']['write'])){ ?>
                        <li><a class="btn btn-default btn-print" href="<?php echo site_url('role/add') ?>"><i class="fa fa-plus"></i> <?php echo translate('add_new') ?></a></li>
                    <?php } ?>
                </ul>

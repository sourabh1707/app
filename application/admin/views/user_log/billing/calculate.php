...
<table border="1" style="padding:5px;" class="table demo-table1">
    <tbody>
         <tr>
            <th><?php echo translate('Terminal Name'); ?> </th>
            <td><?php $tid=$this->uri->segment(3);

            echo $this->CRUD->get_data_row(TBL_TERMINAL,array('id'=>$tid))->name; ?></td>
        </tr>

        <tr>
            <th><?php echo translate('Playlist Name'); ?> </th>
            <td><?php $pid=$this->uri->segment(4);
            echo $this->CRUD->get_data_row(TBL_PLAYLIST,array('id'=>$pid))->name; ?></td>
        </tr>

        <tr>
            <th><?php echo translate('user'); ?> </th>
            <td><?php $user_id = $this->session->userdata('user_id');
            echo $this->CRUD->get_data_row(TBL_USER,array('id'=>$user_id))->name; ?></td>
        </tr>

         <tr>
            <th><?php echo translate('Time second'); ?> </th>
            <td><?php $tt=$this->uri->segment(5);
            echo $tt; ?></td>
        </tr>
    </tbody>
</table>
   ...
   -->
            ...
            <div class="field-column1">
              <?php $tinsec = $this->uri->segment(5);?>
                <label>Time</label>
                <input type="text" class="demo-input-box1" name="time" id="time" value="<?php echo $tinsec;?>" onkeyup="Calculate()" required readonly>
                <label>Rate</label>

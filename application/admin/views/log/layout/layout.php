...
<link href="<?php echo base_url('template/admin') ?>/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
 ...
 <!-- Datatable Dependency start -->
  ...
  <!-- Search filter -->
  <center>
   <form method='post' action='<?php echo site_url(); ?>Admin_Layout_log/fetch_data'>
    ...
    <table class="table table-striped table-bordered" id="table_id">
      <thead>
        <tr>
          ...
          <th class="header">Layout Name</th>
          <th class="header">Layout Status</th>
 ...
 $(document).ready(function(){  
      $('.view_data').click(function(){  
           ...
           $.ajax({  
               ...
               url:"<?php echo base_url(); ?>admin.php/Admin_Layout_log/get_layout_details",  
                method:"post",  
                data:{id:id},  

...
<link href="<?php echo base_url('template/admin') ?>/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
 ...
 <!-- Datatable Dependency start -->
  ...
  <!-- Search filter -->
  <center>
   <form method='post' action='<?php echo site_url(); ?>terminal_log/fetch_terminal_data'>
                  ...
                  //print_r($element['playlist']);die();
                    ...
                    <tr>
                        ...
                        <!--<td><?php echo $duration; ?></td> --> 
                         ...
                         <td><input type="button" name="view" value="<?php echo $element['name'];?>" id="<?php echo $element['terminal_id']; ?>" class="btn btn-link view_data" readonly/></td> 
      ...
      $('.view_data').click(function(){  
           ...
           $.ajax({  
               // url:"<?php echo base_url(); ?>Layout_log/get_layout_details",
                url:"<?php echo base_url(); ?>admin.php/terminal_log/get_details",  
                method:"post",  
                data:{id:id},  

	...
	<?php if(empty($permissions) || isset($permissions['log'])){ ?>
                        <li>
                            <a>
                                <i class="fa fa-terminal"></i> <?php echo translate('schedule_log') ?> <span class="fa fa-chevron-down"></span>
                            </a>
                            <ul class="nav child_menu">
                                <?php if(empty($permissions) || isset($permissions['log'])){ ?>
                                    <li>
		...
		<?php if(empty($permissions) || isset($permissions['log'])){ ?>
                        <li>
                            <a>
                                <i class="fa fa-terminal"></i> <?php echo translate('Client_log') ?> <span class="fa fa-chevron-down"></span>
                            </a>
                            <ul class="nav child_menu">
                                <?php if(empty($permissions) || isset($permissions['log'])){ ?>
                                    <li>
                    ...
                    <?php } ?>
			         ...
			         -->
                                     ...
                                     <li>
                            <a>
                                <i class="fa fa-terminal"></i> <?php echo translate('terminal log') ?> <span class="fa fa-chevron-down"></span>
                            </a>
                            <ul class="nav child_menu">
                                 <?php if(empty($permissions) || isset($permissions['log']['read'])){ ?>
                                    <li><a href="<?php echo site_url('Terminal_log'); ?>">
				    <i class="fa fa-terminal"></i> <?php echo translate('terminal') ?></a></li>
                                <?php } ?>
                                <?php if(empty($permissions) || isset($permissions['log']['read'])){ ?>
                                    <li><a href="<?php echo site_url('group_terminal_log'); ?>">
				    <i class="fa fa-terminal"></i> <?php echo translate('group_terminal') ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
...
<?php if(empty($permissions) || isset($permissions['log']) || isset($permissions['user'])){ 
   // angle-right
    ?>
                        <li>
                            <a> 
                                <i class="fa fa-history"></i> <?php echo translate('User Report') ?> <span class="fa fa-chevron-down"></span>
                            </a>
                            <ul class="nav child_menu">

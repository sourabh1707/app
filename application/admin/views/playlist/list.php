        ...
        <div class="modal-content">
            <form class="form-send_playlist" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/send' ?>">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Send playlist on group terminal</h4>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-send_playlists" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/send_single' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">send playlist on single terminal</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="terminal"><?php echo translate('terminal') ?> <span class="required">*</span></label> 
                                <select class="form-control select2" id="terminal" name="terminal[]" style="width:100%;" data-parsley-errors-container="#error_terminal" required>
                                    <option></option>
                                    <?php
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-schedule_playlist" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/schedule' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Schedule playlist on group terminal</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-schedule_playlists" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/schedule_single' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Schedule playlist on single terminal</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">

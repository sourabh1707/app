        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <?php $permissions = $this->permissions; if(empty($permissions) || isset($permissions['group_terminal']['write'])){ ?>
                    ...
                    <table id="list_datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo translate('terminals_name'); ?></th>
...
<div id="sendu-model" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog">

<?php
$keys = array('system_name','system_logo','system_favicon', 'ui_fixed_footer','ui_fixed_sidebar','font','records_per_page','ui_rtl','ui_fixed_topbar');
                    ...
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="<?php echo site_url('dashboard') ?>" class="site_title">
                                <img src="<?php echo base_url().'uploads/system/'.$header_setting->system_logo; ?>" alt="<?php echo $header_setting->system_name; ?>" style="width: 50px;"> <span><?php echo $header_setting->system_name; ?></span>
                            </a>
                        </div>

...
$config['csrf_exclude_uris'] 	= array('login','profile.*+','profile/upload','settings/crud','role/crud.*+','staff/crud.*+','login/action.*+','language/crud.*+','api/crud.*+','terminal/crud.*+','v1.*+','user/crud.*+','schedular/crud.*+');

...
class Playlist_log extends MY_Controller {
    public $module_name = 'user_log';
    function __construct() {
        parent::__construct();
        $this->load->model('Playlistlog_model','Model');
    }
...
*/
 public function index(){
        ...
        $page_data['page_title'] = 'Playlist Log';
        $page_data['employeeInfo'] = $this->Model->dataList_playlist();
        ...
        $end_date = $this->input->post('endDate');
         ...
         if(isset($_POST['submit'])){
           ...
           // $end_date=date("m/d/Y",strtotime($to_date));
            ...
            $page_data['module_name'] = $this->module_name;
            $page_data['page_name'] = 'playlist/playlist';
            $page_data['search_date'] = $this->Model->fetch_playlist($start_date,$end_date);
                       ...
                       // print_r($id); exit();
                        ...
                        if($playlist){
                           // print_r($playlist); exit();
                            ...
                            $json['details1'] = $this->load->view('user_log/playlist/playlist_details',array('playlist'=>$playlist),true);

...
class Alarm_log_detail extends MY_Controller {
    ...
    public function index(){
        ...
        $page_data['page_name'] = 'alarm/alarm_details';
        //$page_data['page_name'] = 'playlist/export';
        $page_data['page_title'] = 'Alarm Log Details';
    ...
    public function fetch_data(){
         ...
         if(isset($_POST['submit'])){
           ...
           // $end_date=date("m/d/Y",strtotime($to_date1));
            $page_data = array();
            $page_data['module_name'] = $this->module_name;
            $page_data['page_name'] = 'alarm/alarm_details1';
            $page_data['page_title'] = 'Alarm Log Details';
            //$page_data['date_search'] = $this->Model->fetch_log1($start_date,$end_date,$terminal_id);
           // print_r($page_data['search_date']); exit();
            $page_data['date_search'] = $this->db->query("SELECT * FROM `tbl_alarm_log` WHERE log_created_on BETWEEN '$start_date' and '$end_date' AND terminal_id='$id'");
    ...
    public function alarm_data(){
         ...
         if(isset($_POST['submit'])){
            ...
            $page_data['module_name'] = $this->module_name;
            $page_data['page_name'] = 'alarm/alarm_details1';
            $page_data['search_date'] = $this->Model->fetch_all($terminal_id,$status);
            //print_r($page_data['search_date']); exit();
            $page_data['page_title'] = 'Alarm Log details';
            $this->load->view('index',$page_data);        
         }
    ...
    public function alarm_data1(){
         ...
         if(isset($_POST['submit1'])){
            ...
            $page_data = array();
            $page_data['module_name'] = $this->module_name;
            $page_data['page_name'] = 'alarm/alarm_details2';
            $page_data['search_data'] = $this->Model->fetch_date($terminal_id,$status,$start_date,$end_date);
            //print_r($page_data['search_data']); exit();
            $page_data['page_title'] = 'Alarm Log details';
            $this->load->view('index',$page_data);        
         }
    }

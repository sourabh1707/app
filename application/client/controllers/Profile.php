...
class Profile extends MY_Controller {
    ...
    public function index(){
        ...
        if($action!=''){
            ...
            if($action=='edit_profile'){
                ...
                if($user_id!=''){
                    $user = $this->CRUD->get_data_row(TBL_USER,array('id'=>$user_id));
                ...
                if ($this->form_validation->run()){
                    ...
                    $this->CRUD->update_data(TBL_USER,$up_data,array('id'=>$user_id));
        ...
        $page_data['profile'] = $this->CRUD->get_data_row(TBL_USER,array('id'=>$user_id));
    ...
    function old_password(){
        ...
        if($this->CRUD->get_data_row(TBL_USER,array('id'=>$user_id,'password'=> sha1($old_password)))){
            return true;
        }

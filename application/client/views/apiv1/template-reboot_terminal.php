...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo translate('reboot_terminal_api_parameters_and_response'); ?></h2>
        ...
        <div class="x_content">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-reboot_terminal" method="post" enctype="multipart/form-data" action="<?php echo site_url('apiv1/crud/get_api_response') ?>">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="delay"><?php echo translate('delay') ?> <span class="required">*</span> </label>
                                    <input type="number" name="delay" id="delay" min="1" placeholder="<?php echo translate('delay') ?>" class="form-control" required>
                                    <?php parsley_error(form_error('delay')) ?>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <input type="hidden" name="action" id="reboot_terminal_action" value="reboot_terminal">
                                    <button type="button" data-type="reboot_terminal" data-bs='<?php echo translate('getting_response'); ?>' data-as='<?php echo translate('get_response'); ?>' class="btn btn-submit btn-block btn-success"><?php echo translate('get_response'); ?></button>
                                </div>
                            </div>

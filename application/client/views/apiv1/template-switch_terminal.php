...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo translate('switch_terminal_api_parameters_and_response'); ?></h2>
        ...
        <div class="x_content">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-switch_terminal" method="post" enctype="multipart/form-data" action="<?php echo site_url('apiv1/crud/get_api_response') ?>">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="status"><?php echo translate('status') ?> <span class="required">*</span> </label>
                                    <select class="form-control select2" id="status" name="status" style="html:100%;" data-parsley-errors-container="#error_status" required>
                                        <option></option>
                                        <?php
                                            $statuss = array('on','off');
                                            if (isset($statuss) && !empty($statuss)) {
                                                foreach ($statuss as $skey => $status) {
                                                    echo '<option value="' . $status . '" >' . translate($status) . '</option>';
                                                }
                                            }
                                        ?>
                                    </select>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <input type="hidden" name="action" id="switch_terminal_action" value="switch_terminal">
                                    <button type="button" data-type="switch_terminal" data-bs='<?php echo translate('getting_response'); ?>' data-as='<?php echo translate('get_response'); ?>' class="btn btn-submit btn-block btn-success"><?php echo translate('get_response'); ?></button>
                                </div>
                            </div>

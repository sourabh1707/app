...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo translate('get_APK_version_api_parameters_and_response'); ?></h2>
        ...
        <div class="x_content">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-get_apk_version" method="post" enctype="multipart/form-data" action="<?php echo site_url('apiv1/crud/get_api_response') ?>">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="apk"><?php echo translate('APK') ?> <span class="required">*</span> </label>
                                    <input type="text" name="apk" id="value" class="form-control" required>
                                    <?php parsley_error(form_error('apk')) ?>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <input type="hidden" name="action" id="get_apk_version_action" value="get_apk_version">
                                    <button type="button" data-type="get_apk_version" data-bs='<?php echo translate('getting_response'); ?>' data-as='<?php echo translate('get_response'); ?>' class="btn btn-submit btn-block btn-success"><?php echo translate('get_response'); ?></button>
                                </div>
                            </div>

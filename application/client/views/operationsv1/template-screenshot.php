...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo translate('screenshot'); ?></h2>
        ...
        <div class="x_content">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-set_url" method="post" enctype="multipart/form-data" action="<?php echo site_url('operationsv1/crud/get_api_response') ?>">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <input type="hidden" name="action" id="screenshot_action" value="get_screenshot">

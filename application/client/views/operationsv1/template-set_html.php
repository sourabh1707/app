...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-set_html" method="post" enctype="multipart/form-data" action="<?php echo site_url('operationsv1/crud/get_api_response') ?>">
                        <div class="row">

<table border="1" style="padding:5px;">
    <tbody>
        ...
        <?php if($log->terminal_id!=0){ ?>
             <tr>
            <td colspan="2"><?php echo translate('terminal details'); ?></td>
        </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo $this->CRUD->get_data_row(TBL_TERMINAL,array('id'=>$log->terminal_id))->client_alise; ?></td>
            </tr>
            <tr>
                <th><?php echo translate('status'); ?> </th>
                <td><?php $this->CRUD->get_data_row(TBL_TERMINAL,array('id'=>$log->terminal_id)); 
             if($log->is_active=1){
            ...
            <td><?php echo $this->CRUD->get_data_row(TBL_TERMINAL,array('id'=>$log->terminal_id))->created_on; ?></td>
        </tr>
        <tr>
            <th><?php echo translate('updated_on'); ?></th>
            <td><?php echo $this->CRUD->get_data_row(TBL_TERMINAL,array('id'=>$log->terminal_id))->updated_on; ?></td>
        </tr>

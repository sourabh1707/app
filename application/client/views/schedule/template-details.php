...
<table class="table table-striped">
    <tbody>
        <tr>
            ...
            <td style="display:none;"><?php echo $schedule->playlist_id;?></td>
        </tr>
        <tr>
            ...
            <td>
                <table class="table table-striped">
                    <tbody>
                        ...
                        <?php 
                            $schedules = isset($schedule->playlist) && !empty(unserialize($schedule->playlist)) ? unserialize($schedule->playlist) : array();

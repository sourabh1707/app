...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo translate('marquee'); ?></h2>
        ...
        <div class="x_content">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-set_marquee" method="post" enctype="multipart/form-data" action="<?php echo site_url('operationsv2/crud/get_api_response') ?>">
                        <div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="terminal_id"><?php echo translate('terminal') ?> <span class="required">*</span> </label>
                                    <select class="form-control select2" id="terminal_id" name="terminal_id[]" style="width:100%;" data-parsley-errors-container="#error_terminal_id" multiple required>
                                        <option></option>
                                        <?php
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="scrolldelay"><?php echo translate('scroll_delay'); ?> <span class="required">*</span></label>
                                    <input type="number" min="0" name="scrolldelay" id="scrolldelay" class="form-control" value="0">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="-1" name="loop" id="loop" class="form-control" value="-1">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="align" name="align" style="width:100%;" data-parsley-errors-container="#error_align" required>
                                        <option></option>
                                        <?php
                                            $aligns = array('top','middle','bottom');
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="behavior"><?php echo translate('behavior') ?> <span class="required">*</span> </label>
                                    <select class="form-control select2" id="behavior" name="behavior" style="width:100%;" data-parsley-errors-container="#error_behavior" required>
                                        <option></option>
                                        <?php
                                            $aligns = array('scroll','slide','alternate');
                                            if (isset($aligns) && !empty($aligns)) {
                                                foreach ($aligns as $akey => $align) {
                                                    echo '<option value="' . $align . '" >' . translate($align) . '</option>';
                                                }
                                    ...
                                    <span id="error_behavior"></span>
                                    <?php parsley_error(form_error('behavior')) ?>
                                </div>
                            </div>

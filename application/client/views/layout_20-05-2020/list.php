        ...
        <div class="modal-content">
            <form class="form-send_layout" method="post" enctype="multipart/form-data" action="<?php echo site_url().'layout/crud/send' ?>">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">send layout to group terminal</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type='hidden' name='id' id='layout_id' value=''>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-send_layouts" method="post" enctype="multipart/form-data" action="<?php echo site_url().'layout/crud/send_single' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">send layout to single terminal</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <button type="button" data-type="send_layouts" class="btn btn-submit btn-success" data-as='<i class="fa fa-share"></i> <?php echo translate('send_single'); ?>' data-bs='<i class="fa fa-share"></i> <?php echo translate('sending'); ?>'><i class="fa fa-share"></i> <?php echo translate('send'); ?></button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo translate('close'); ?></button>
                            </div>
                        </div>
                    </div>
...
<div id="schedulet-model" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-schedule_layouts" method="post" enctype="multipart/form-data" action="<?php echo site_url().'layout/crud/schedule_single' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" data-type="schedule_layouts" class="btn btn-submit btn-success" data-as='<i class="fa fa-share"></i> <?php echo translate('schedule_single'); ?>' data-bs='<i class="fa fa-share"></i> <?php echo translate('scheduleing'); ?>'><i class="fa fa-share"></i> <?php echo translate('schedule'); ?></button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo translate('close'); ?></button>
                            </div>
                        </div>
                    </div>

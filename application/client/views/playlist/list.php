        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li><a class="btn btn-default btn-print" href="<?php echo site_url('playlist/add') ?>"><i class="fa fa-plus"></i> <?php echo translate('add_new') ?></a></li>
                </ul>
...
<div id="send-model" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-send_playlist" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/send' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">send playlist to group terminal</h4>
                </div>
                    ...
                    <div class="row">
                                    ...
                                    <?php
                                        if (isset($terminals) && !empty($terminals)) {
                                            foreach ($terminals as $vkey => $terminal) {
                                                $gtarray = array();
                                                $alisse = unserialize($terminal->group_terminal); 
                                                $alise = $terminal->client_alise!='' ? ' - (' . $terminal->client_alise. ')' : '';
                                                echo '<option value="' . $terminal->id . '" >'.$terminal->name . $alise .'</option>';
                                                // echo '<option value="' . $terminal->id . '" >'.$terminal->name.' ('.$terminal->group_terminal .')</option>';
                                            }
                                        }
                                    ?>
                                </select>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <button type="button" data-type="send_playlist" class="btn btn-submit btn-success" data-as='<i class="fa fa-share"></i> <?php echo translate('send'); ?>' data-bs='<i class="fa fa-share"></i> <?php echo translate('sending'); ?>'><i class="fa fa-share"></i> <?php echo translate('send'); ?></button>
...
<div id="sendt-model" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-send_playlists" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/send_single' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">send playlist to single terminal</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="terminal[]" name="terminal[]" style="width:100%;" data-parsley-errors-container="#error_terminal">
                                    <option></option>
                                    <?php
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <button type="button" data-type="send_playlists" class="btn btn-submit btn-success" data-as='<i class="fa fa-share"></i> <?php echo translate('send_single'); ?>' data-bs='<i class="fa fa-share"></i> <?php echo translate('sending'); ?>'><i class="fa fa-share"></i> <?php echo translate('send'); ?></button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo translate('close'); ?></button>
                            </div>
                        </div>
                    </div>
...
<div id="schedule-model" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-schedule_playlist" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/schedule' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Schedule Playlist to Terminal</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" data-type="schedule_playlist" class="btn btn-submit btn-success" data-as='<i class="fa fa-share"></i> <?php echo translate('schedule'); ?>' data-bs='<i class="fa fa-share"></i> <?php echo translate('scheduleing'); ?>'><i class="fa fa-share"></i> <?php echo translate('schedule'); ?></button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo translate('close'); ?></button>
                            </div>
                        </div>
                    </div>
...
<div id="schedulet-model" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-schedule_playlists" method="post" enctype="multipart/form-data" action="<?php echo site_url().'playlist/crud/schedule_single' ?>">
                <div class="modal-header">
                    <button type="button" class="close close-model" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Schedule Playlist to single Terminal</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" data-type="schedule_playlists" class="btn btn-submit btn-success" data-as='<i class="fa fa-share"></i> <?php echo translate('schedule_single'); ?>' data-bs='<i class="fa fa-share"></i> <?php echo translate('scheduleing'); ?>'><i class="fa fa-share"></i> <?php echo translate('schedule'); ?></button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo translate('close'); ?></button>
                            </div>
                        </div>
                    </div>

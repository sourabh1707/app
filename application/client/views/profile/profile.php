                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="user_email" name="user_email" placeholder="<?php echo translate('email'); ?>" value="<?php echo isset($profile->user_email) && $profile->user_email != '' ? $profile->user_email : ''; ?>" readonly required >

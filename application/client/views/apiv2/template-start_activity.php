...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo translate('start_activity_api_parameters_and_response'); ?></h2>
        ...
        <div class="x_content">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-start_activity" method="post" enctype="multipart/form-data" action="<?php echo site_url('apiv2/crud/get_api_response') ?>">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="activity"><?php echo translate('activity') ?> <span class="required">*</span> </label>
                                    <input type="text" name="activity" id="activity" placeholder="<?php echo translate('activity') ?>" class="form-control" required>
                                    <?php parsley_error(form_error('activity')) ?>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <input type="hidden" name="action" id="start_activity_action" value="start_activity">
                                    <button type="button" data-type="start_activity" data-bs='<?php echo translate('getting_response'); ?>' data-as='<?php echo translate('get_response'); ?>' class="btn btn-submit btn-block btn-success"><?php echo translate('get_response'); ?></button>
                                </div>
                            </div>

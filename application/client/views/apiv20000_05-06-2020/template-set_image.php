...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo translate('set_image_api_parameters_and_response'); ?></h2>
        ...
        <div class="x_content">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-set_image" method="post" enctype="multipart/form-data" action="<?php echo site_url('apiv2/crud/get_api_response') ?>">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="terminal_id"><?php echo translate('terminal') ?> <span class="required">*</span></label>
                                    <select class="form-control select2" id="terminal_id" name="terminal_id" style="image:100%;" data-parsley-errors-container="#error_terminal_id" required>
                                        <option></option>
                                        <?php
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <?php /*<select class="form-control select2" id="height" name="height" style="image:100%;" data-parsley-errors-container="#error_height" required>
                                        <option></option>
                                        <?php
                                            for ($x = 1; $x <= 100; $x++) {
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <?php /*<select class="form-control select2" id="width" name="width" style="image:100%;" data-parsley-errors-container="#error_width" required>
                                        <option></option>
                                        <?php
                                            for ($x = 1; $x <= 100; $x++) {
                                                echo '<option value="' . $x . '" >' . $x . '</option>';

    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <a href="javascript:void(0);" data-type="get_start_activity" style="margin: 10px" class="btn btn-default api-form">
                    <?php echo translate('start_activity'); ?>
                </a>
                <a href="javascript:void(0);" data-type="set_background" style="margin: 10px" class="btn btn-default api-form">
                    <?php echo translate('set_background'); ?>
                </a>
            </div>
        </div>
    </div>

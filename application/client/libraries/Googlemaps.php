...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCUSFASymIE_o6L7rnO4EMbCBzvcM17LUw'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console

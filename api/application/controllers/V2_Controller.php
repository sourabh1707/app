...
class V2_Controller extends CI_Controller {
    var $terminal_id = '' ;
    var $terminal_folder = '' ;
    var $terminal_url = '' ;
	...
	$this->pre_html = '<link rel="stylesheet" href="'.base_url('fonts/index.css').'">';
        ...
        if($method!='index'){
            ...
            $this->terminal_url = 'http://localhost:8081/command/'.$this->terminal_id;
        }
    }
    ...
    public function send_xwalk($url='') {
        $fndata = array(
            "url" => $url,
            "persistent" => true
        );
        ...
        return $this->post($this->terminal_url, $data);
    }
}
